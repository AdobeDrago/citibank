...
## Migration Pilot Proposal

This repository is currently being used to prototype an **EDS migration pilot for Citibank**, evaluating whether hosted ELP pages, Pega-driven personalization, and a headless credit-cards page can move to Edge Delivery Services.
...
├── fonts/           # Web fonts
├── icons/           # SVG icons
├── docs/            # GitHub Pages docs — NOT EDS content, not served by *.aem.page/*.aem.live
    ├── index.html      # Citibank EDS migration pilot proposal/tracker (see "Migration Pilot Proposal" below)
    └── icons/          # Assets for docs/index.html (e.g. Citi brand mark)
...
- Maintain responsive design principles
  - Declare styles mobile first, use `min-width` media queries at 768px/992px/1200px for tablet and desktop
