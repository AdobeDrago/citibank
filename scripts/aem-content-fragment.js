 ...
 *
 * Default host: Drago publish. Override with `?aemOrigin=` (e.g. local AEM)
 * for optional trials — does not auto-switch on localhost.
 *
 * - Credit cards: POST creditCardByPath(_path, variation)
...
/**
 * GraphQL origin: Drago publish by default; `?aemOrigin=` for optional local AEM.
 * @returns {string}
 */
